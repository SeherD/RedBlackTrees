					...
					if (x == x.parent.left()) {
						if (x.parent.right.colour == Colour.BLACK && x.parent.right.right != null
							...
							break;
								...
								&& !x.parent.right.isNil() && x.parent.right.right.colour == x.parent.right.left.colour
								&& x.parent.right.left.colour == Colour.BLACK) {

							x = delete_case_3b(x);

						} else if (x.parent.right.left.colour == Colour.RED && x.parent.right.colour == Colour.BLACK
								&& !x.parent.right.isNil() && x.parent.right.right.colour == Colour.BLACK) {
						...
						} else if (x.parent.left.right != null && x.parent.left.right.colour == Colour.RED
								&& x.parent.left.colour == Colour.BLACK && x.parent.left.left.colour == Colour.BLACK) {
						...
						} else if (x.parent.left.left != null && x.parent.colour == Colour.BLACK
								&& x.parent.left.colour == Colour.BLACK && x.parent.left.left.colour == Colour.BLACK
								&& x.parent.left.right.colour == Colour.BLACK) {
